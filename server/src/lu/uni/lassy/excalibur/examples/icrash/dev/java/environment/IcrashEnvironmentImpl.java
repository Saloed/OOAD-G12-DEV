...
public class IcrashEnvironmentImpl extends UnicastRemoteObject implements IcrashEnvironment {
     ...
     */
    private Hashtable<String, ActAdministrator> admins = new Hashtable<>();
    /**
     ...
     */
    private Hashtable<String, ActComCompany> comCompanies = new Hashtable<>();
    /**
     * The coordinators stored in the environment.
     * Key = ActCoordinator's login's name
     */
    private Hashtable<String, ActCoordinator> coordinators = new Hashtable<>();
