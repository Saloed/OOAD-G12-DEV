...
public class IncorrectFormatException extends Exception {
     ...
     */
    private ArrayList<String> _dataPassed = new ArrayList<>();
    /**
     * The expected format of the data type.
     */
    private ArrayList<String> _expectedFormat = new ArrayList<>();
    ...
    public String getMessage() {
        ...
        for (int i = 0; i < max; i++) {
            sb.append("The expected format of ").append(_expectedFormat.get(i)).append(" did not apply to the value ").append(_dataPassed.get(i)).append("\n\n");
        }
